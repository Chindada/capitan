...
const (
	...
	tableNameSystemEventLogin   string = "system_event_login"
	tableNameSystemEventShioaji string = "system_event_shioaji"
	tableNameSystemTotp         string = "system_totp"

	tableNameTradeRecord string = "trade_record"
)
